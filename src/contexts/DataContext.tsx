...
interface DataContextType {
  ...
  pasar: Pasar[];
  setPasar: React.Dispatch<React.SetStateAction<Pasar[]>>;
  komoditas: Komoditas[];
  setKomoditas: React.Dispatch<React.SetStateAction<Komoditas[]>>;
  tempatUsaha: TempatUsaha[];
  setTempatUsaha: React.Dispatch<React.SetStateAction<TempatUsaha[]>>;
  komoditasDijual: KomoditasDijual[];
  setKomoditasDijual: React.Dispatch<React.SetStateAction<KomoditasDijual[]>>;
  hargaRutin: HargaRutin[];
  setHargaRutin: React.Dispatch<React.SetStateAction<HargaRutin[]>>;
  ...
  updateTempatUsaha: (
    id: string,
    t: Partial<TempatUsaha>,
  ) => Promise<TempatUsaha>;
  deleteTempatUsaha: (id: string) => Promise<void>;
  addKomoditasDijual: (k: Omit<KomoditasDijual, "id">) => void;
  createKomoditasDijual: (
    k: Omit<KomoditasDijual, "id">,
  ) => Promise<KomoditasDijual>;
  updateKomoditasDijual: (
    id: string,
    k: Partial<KomoditasDijual>,
  ) => Promise<KomoditasDijual>;
...
function generateMockData() {
  ...
  const mockPasar: Pasar[] = [
    ...
    },
    {
      ...
      longitude: 107.6089,
      latitude: -6.9175,
      alamat: "Jl. Ahmad Yani No. 221, Bandung",
      is_active: 1,
    },
    {
      id: pasarIds[2],
    ...
    {
      id: pasarIds[3],
      nama: "Pasar Sederhana",
      longitude: 107.5955,
      latitude: -6.8945,
      alamat: "Jl. Sederhana No. 35, Bandung",
      is_active: 1,
    },
    {
      id: pasarIds[4],
      ...
      longitude: 107.592,
      latitude: -6.911,
      alamat: "Jl. Ciroyom No. 15, Bandung",
      is_active: 0,
    },
  ];
  ...
  const mockTempatUsaha: TempatUsaha[] = [
    ...
    },
    {
      ...
      nama_narahubung: "Ibu Siti",
      nomor_narahubung: "081234567891",
      berjualan_sejak: "2018-07-15",
      is_active: 1,
      pasar_id: pasarIds[0],
    },
    {
      id: tuIds[2],
      nama: "Toko Sejahtera",
      nama_pemilik: "Pak Udin",
      nama_narahubung: "Dedi",
      nomor_narahubung: "081234567892",
      berjualan_sejak: "2020-01-05",
      is_active: 1,
      pasar_id: pasarIds[0],
    },
    {
      id: tuIds[3],
      nama: "Toko Sari Rasa",
      nama_pemilik: "Ibu Nining",
      nama_narahubung: "Ibu Nining",
      nomor_narahubung: "081345678901",
      berjualan_sejak: "2012-05-20",
      is_active: 1,
      pasar_id: pasarIds[1],
    },
    {
      id: tuIds[4],
      nama: "Toko Mulia",
      nama_pemilik: "H. Kosim",
      nama_narahubung: "Ade",
      nomor_narahubung: "081345678902",
      berjualan_sejak: "2016-11-08",
      is_active: 1,
      pasar_id: pasarIds[1],
    },
    {
      ...
      nama_narahubung: "Ibu Rina",
      nomor_narahubung: "081345678903",
      berjualan_sejak: "2019-02-14",
      is_active: 1,
      pasar_id: pasarIds[1],
    },
    {
      ...
      nama_narahubung: "Pak Joko",
      nomor_narahubung: "081456789012",
      berjualan_sejak: "2010-08-01",
      is_active: 1,
      pasar_id: pasarIds[2],
    },
    {
      ...
      nama_narahubung: "Sari",
      nomor_narahubung: "081456789013",
      berjualan_sejak: "2017-04-22",
      is_active: 1,
      pasar_id: pasarIds[2],
    },
    {
      id: tuIds[8],
      nama: "Toko Bintang",
      nama_pemilik: "Pak Rudi",
      nama_narahubung: "Pak Rudi",
      nomor_narahubung: "081456789014",
      berjualan_sejak: "2021-06-10",
      is_active: 0,
      pasar_id: pasarIds[2],
    },
    {
      ...
      nama_narahubung: "Ibu Ani",
      nomor_narahubung: "081567890123",
      berjualan_sejak: "2014-09-30",
      is_active: 1,
      pasar_id: pasarIds[3],
    },
    {
      id: tuIds[10],
      nama: "Toko Harapan",
      nama_pemilik: "Pak Dadan",
      nama_narahubung: "Pak Dadan",
      nomor_narahubung: "081567890124",
      berjualan_sejak: "2019-12-01",
      is_active: 1,
      pasar_id: pasarIds[3],
    },
    {
      id: tuIds[11],
      nama: "Toko Rejeki",
      nama_pemilik: "Ibu Yanti",
      nama_narahubung: "Ibu Yanti",
      nomor_narahubung: "081567890125",
      berjualan_sejak: "2022-03-15",
      is_active: 1,
      pasar_id: pasarIds[3],
    },
  ];
  ...
  const mockKomoditasDijual: KomoditasDijual[] = [
    {
      id: "kd-001",
      tempat_usaha_id: tuIds[0],
      komoditas_id: komIds[0],
      harga_normal: 14000,
      harga_mahal: 16000,
      satuan_stok: "kg",
      nilai_stok: 500,
    ...
    },
    {
      ...
      nilai_periode: 1,
      periode_unit: "minggu",
      lokasi_supplier: "Karawang",
      pola_distribusi: "pemesanan_produsen",
      standardized_stock_periode: 42.9,
      is_active: true,
    },
    {
      id: "kd-003",
      tempat_usaha_id: tuIds[2],
      komoditas_id: komIds[0],
      harga_normal: 12500,
      harga_mahal: 13500,
      satuan_stok: "kg",
      ...
      nilai_periode: 1,
      periode_unit: "minggu",
      lokasi_supplier: "Cianjur",
      pola_distribusi: "pembelian_pasar",
      standardized_stock_periode: 21.4,
      is_active: true,
    },

    {
      ...
      nilai_periode: 3,
      periode_unit: "hari",
      lokasi_supplier: "Garut",
      pola_distribusi: "pembelian_pasar",
      standardized_stock_periode: 33.3,
      is_active: true,
    },
    {
      id: "kd-005",
    ...
    },
    {
      ...
      nilai_periode: 3,
      periode_unit: "hari",
      lokasi_supplier: "Tasikmalaya",
      pola_distribusi: "pembelian_pasar",
      standardized_stock_periode: 10,
      is_active: true,
    },

    {
      id: "kd-007",
      tempat_usaha_id: tuIds[3],
      komoditas_id: komIds[0],
      harga_normal: 14500,
      harga_mahal: 16500,
      satuan_stok: "kg",
      ...
      periode_unit: "minggu",
      lokasi_supplier: "Subang",
      pola_distribusi: "pemesanan_supplier",
      standardized_stock_periode: 85.7,
      is_active: true,
    },
    {
      id: "kd-008",
      tempat_usaha_id: tuIds[4],
      komoditas_id: komIds[0],
      harga_normal: 13500,
      harga_mahal: 15000,
      satuan_stok: "kg",
      ...
      periode_unit: "minggu",
      lokasi_supplier: "Karawang",
      pola_distribusi: "rutin_produsen",
      standardized_stock_periode: 50,
      is_active: true,
    },
    {
      id: "kd-009",
      tempat_usaha_id: tuIds[5],
      komoditas_id: komIds[0],
      harga_normal: 12000,
      harga_mahal: 13000,
      satuan_stok: "kg",
      ...
      lokasi_supplier: "Cianjur",
      pola_distribusi: "pembelian_pasar",
      standardized_stock_periode: 28.6,
      is_active: true,
    },

    {
      ...
      nilai_periode: 5,
      periode_unit: "hari",
      lokasi_supplier: "Brebes",
      pola_distribusi: "rutin_supplier",
      standardized_stock_periode: 16,
      is_active: true,
    },
    {
      id: "kd-011",
    ...
    },
    {
      ...
      nilai_periode: 5,
      periode_unit: "hari",
      lokasi_supplier: "Cirebon",
      pola_distribusi: "pembelian_pasar",
      standardized_stock_periode: 5,
      is_active: true,
    },

    {
      id: "kd-013",
      tempat_usaha_id: tuIds[6],
      komoditas_id: komIds[3],
      harga_normal: 18000,
      harga_mahal: 22000,
      satuan_stok: "liter",
      nilai_stok: 200,
    ...
    },
    {
      ...
      lokasi_supplier: "Jakarta",
      pola_distribusi: "rutin_supplier",
      standardized_stock_periode: 17.1,
      is_active: true,
    },
    {
      id: "kd-015",
      tempat_usaha_id: tuIds[8],
      komoditas_id: komIds[3],
      harga_normal: 16000,
      harga_mahal: 18500,
      satuan_stok: "liter",
      ...
      nilai_periode: 1,
      periode_unit: "minggu",
      lokasi_supplier: "Surabaya",
      pola_distribusi: "pembelian_pasar",
      standardized_stock_periode: 7.1,
      is_active: true,
    },
    ...
    {
      id: "kd-018",
      tempat_usaha_id: tuIds[9],
      komoditas_id: komIds[5],
      harga_normal: 36000,
      harga_mahal: 42000,
      satuan_stok: "kg",
      nilai_stok: 80,
      nilai_periode: 3,
      periode_unit: "hari",
      lokasi_supplier: "Lembang",
      pola_distribusi: "pembelian_produsen",
      standardized_stock_periode: 26.7,
      is_active: true,
    },
    {
      id: "kd-019",
      tempat_usaha_id: tuIds[10],
      komoditas_id: komIds[5],
      harga_normal: 34000,
      harga_mahal: 38000,
      satuan_stok: "kg",
      ...
      lokasi_supplier: "Lembang",
      pola_distribusi: "rutin_produsen",
      standardized_stock_periode: 16.7,
      is_active: true,
    },
    {
      id: "kd-020",
      tempat_usaha_id: tuIds[11],
      komoditas_id: komIds[5],
      harga_normal: 32000,
      harga_mahal: 36000,
      satuan_stok: "kg",
...

    {
      ...
      nilai_periode: 5,
      periode_unit: "hari",
      lokasi_supplier: "Import China",
      pola_distribusi: "pemesanan_supplier",
      standardized_stock_periode: 14,
      is_active: true,
    },
    {
      id: "kd-025",
    ...
    mockHargaRutin.push(
      {
        ...
        tempat_usaha_id: tuIds[0],
        harga_input: berasHargaBesar[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: berasHargaBesar[6 - i],
        status: "finalisasi",
      },
      {
        id: `hr-beras-m-${i}`,
        ...
        pasar_id: pasarIds[0],
        komoditas_id: komIds[0],
        kelas_komoditas: "menengah",
        tempat_usaha_id: tuIds[1],
        harga_input: berasHargaMenengah[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: berasHargaMenengah[6 - i],
        status: "finalisasi",
      },
      {
        id: `hr-beras-k-${i}`,
        ...
        pasar_id: pasarIds[0],
        komoditas_id: komIds[0],
        kelas_komoditas: "kecil",
        tempat_usaha_id: tuIds[2],
        harga_input: berasHargaKecil[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: berasHargaKecil[6 - i],
        status: "finalisasi",
      },
    );
  }
  ...
  for (let i = 6; i >= 0; i--) {
    ...
    mockHargaRutin.push(
      {
        id: `hr-cabai-b-${i}`,
        nama_enumerator: "Budi Petugas",
        tanggal: tgl,
        pasar_id: pasarIds[0],
        komoditas_id: komIds[1],
        kelas_komoditas: "besar",
        tempat_usaha_id: tuIds[0],
        harga_input: cabaiHargaBesar[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: cabaiHargaBesar[6 - i],
        status: "finalisasi",
      },
      {
        id: `hr-cabai-m-${i}`,
        ...
        kelas_komoditas: "menengah",
        tempat_usaha_id: tuIds[1],
        harga_input: cabaiHargaMenengah[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: cabaiHargaMenengah[6 - i],
        status: "finalisasi",
      },
      {
        id: `hr-cabai-k-${i}`,
        ...
        kelas_komoditas: "kecil",
        tempat_usaha_id: tuIds[2],
        harga_input: cabaiHargaKecil[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: cabaiHargaKecil[6 - i],
        status: "finalisasi",
      },
    );
  }
  ...
  for (let i = 6; i >= 0; i--) {
    ...
    mockHargaRutin.push(
      {
        id: `hr-bawang-b-${i}`,
        nama_enumerator: "Cici Enumerator",
        tanggal: tgl,
        pasar_id: pasarIds[1],
        komoditas_id: komIds[2],
        kelas_komoditas: "besar",
        tempat_usaha_id: tuIds[3],
        harga_input: bawangHargaBesar[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: bawangHargaBesar[6 - i],
        status: "finalisasi",
      },
      {
        id: `hr-bawang-m-${i}`,
        ...
        kelas_komoditas: "menengah",
        tempat_usaha_id: tuIds[4],
        harga_input: bawangHargaMenengah[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: bawangHargaMenengah[6 - i],
        status: "finalisasi",
      },
      {
        id: `hr-bawang-k-${i}`,
        ...
        kelas_komoditas: "kecil",
        tempat_usaha_id: tuIds[5],
        harga_input: bawangHargaKecil[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: bawangHargaKecil[6 - i],
        status: "finalisasi",
      },
    );
  }
  ...
  for (let i = 6; i >= 0; i--) {
    ...
    mockHargaRutin.push(
      {
        id: `hr-minyak-b-${i}`,
        nama_enumerator: "Dedi Surveyor",
        tanggal: tgl,
        pasar_id: pasarIds[2],
        komoditas_id: komIds[3],
        kelas_komoditas: "besar",
        tempat_usaha_id: tuIds[6],
        harga_input: minyakHargaBesar[6 - i],
        jumlah_input: 1,
        satuan_input: "liter",
        harga: minyakHargaBesar[6 - i],
        status: "finalisasi",
      },
      {
        id: `hr-minyak-m-${i}`,
        ...
        kelas_komoditas: "menengah",
        tempat_usaha_id: tuIds[7],
        harga_input: minyakHargaMenengah[6 - i],
        jumlah_input: 1,
        satuan_input: "liter",
        harga: minyakHargaMenengah[6 - i],
        status: "finalisasi",
      },
      {
        id: `hr-minyak-k-${i}`,
        ...
        kelas_komoditas: "kecil",
        tempat_usaha_id: tuIds[8],
        harga_input: minyakHargaKecil[6 - i],
        jumlah_input: 1,
        satuan_input: "liter",
        harga: minyakHargaKecil[6 - i],
        status: "finalisasi",
      },
    );
  }
  ...
  for (let i = 6; i >= 0; i--) {
    ...
    mockHargaRutin.push(
      {
        id: `hr-ayam-b-${i}`,
        nama_enumerator: "Evi Petugas",
        tanggal: tgl,
        pasar_id: pasarIds[3],
        komoditas_id: komIds[5],
        kelas_komoditas: "besar",
        tempat_usaha_id: tuIds[9],
        harga_input: ayamHargaBesar[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: ayamHargaBesar[6 - i],
        status: "finalisasi",
      },
      {
        id: `hr-ayam-m-${i}`,
        ...
        kelas_komoditas: "menengah",
        tempat_usaha_id: tuIds[10],
        harga_input: ayamHargaMenengah[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: ayamHargaMenengah[6 - i],
        status: "finalisasi",
      },
      {
        id: `hr-ayam-k-${i}`,
        ...
        kelas_komoditas: "kecil",
        tempat_usaha_id: tuIds[11],
        harga_input: ayamHargaKecil[6 - i],
        jumlah_input: 1,
        satuan_input: "kg",
        harga: ayamHargaKecil[6 - i],
        status: "finalisasi",
      },
    );
  }
...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const [komoditas, setKomoditas] = useState<Komoditas[]>(() =>
    load("komoditas", defaults.mockKomoditas),
  );
  const [tempatUsaha, setTempatUsaha] = useState<TempatUsaha[]>(() =>
    load("tempatUsaha", defaults.mockTempatUsaha),
  );
  const [komoditasDijual, setKomoditasDijual] = useState<KomoditasDijual[]>(
    () => load("komoditasDijual", defaults.mockKomoditasDijual),
  );
  const [hargaRutin, setHargaRutin] = useState<HargaRutin[]>(() =>
    load("hargaRutin", defaults.mockHargaRutin),
  );
  ...
  const addPasar = (p: Omit<Pasar, "id">) =>
    persist("pasar", setPasar, (prev) => [...prev, { ...p, id: uid() }]);
  ...
  const createPasar = useCallback(
    async (p: Omit<Pasar, "id">): Promise<Pasar> => {
  ...
  const updatePasar = useCallback(
    async (id: string, p: Partial<Pasar>): Promise<Pasar> => {
      const updated = await updatePasarApi(id, p);
      persist("pasar", setPasar, (prev) =>
  ...
  const deletePasar = useCallback(
    async (id: string): Promise<void> => {
      ...
      persist("pasar", setPasar, (prev) =>
        prev.map((x) => (x.id === id ? { ...x, is_active: 0 } : x)),
      );
    },
    [persist],
  );
  ...
  const addKomoditas = (k: Omit<Komoditas, "id">) =>
    persist("komoditas", setKomoditas, (prev) => [
      ...prev,
      { ...k, id: uid() },
    ]);

  const createKomoditas = useCallback(
    async (
      k: Omit<Komoditas, "id">,
      imageFile?: File | null,
    ): Promise<Komoditas> => {
  ...
  const updateKomoditas = useCallback(
    async (
      id: string,
      k: Partial<Komoditas>,
      imageFile?: File | null,
  ...
  const deleteKomoditas = (id: string) =>
    persist("komoditas", setKomoditas, (prev) =>
      prev.filter((x) => x.id !== id),
    );

  /* ===== CRUD Tempat Usaha (via /v1/admin/tempat-usaha) ===== */
  const addTempatUsaha = (t: Omit<TempatUsaha, "id">) =>
    persist("tempatUsaha", setTempatUsaha, (prev) => [
      ...prev,
      { ...t, id: uid() },
    ]);
      ...
      setTempatUsaha((prev) => {
        const merged = mapped.map((item) => {
          ...
          return {
            ...
            nomor_narahubung:
              existing?.nomor_narahubung ?? item.nomor_narahubung,
  ...
  const createTempatUsaha = useCallback(
    async (t: Omit<TempatUsaha, "id">): Promise<TempatUsaha> => {
  ...
  const updateTempatUsaha = useCallback(
    async (id: string, t: Partial<TempatUsaha>): Promise<TempatUsaha> => {
      ...
      const mapped: TempatUsaha = {
        ...
        nama_narahubung:
          t.nama_narahubung ??
          existing?.nama_narahubung ??
          updated.nama_narahubung,
        nomor_narahubung:
          t.nomor_narahubung ??
          existing?.nomor_narahubung ??
          updated.nomor_narahubung,
        berjualan_sejak:
          t.berjualan_sejak ??
          existing?.berjualan_sejak ??
          updated.berjualan_sejak,
      };
      persist("tempatUsaha", setTempatUsaha, (prev) =>
  ...
  const deleteTempatUsaha = useCallback(
    async (id: string): Promise<void> => {
      ...
      setKomoditasDijual((prev) => {
        if (tempatUsahaId) {
          const others = prev.filter(
            (kd) => kd.tempat_usaha_id !== tempatUsahaId,
          );
  ...
  const addKomoditasDijual = (k: Omit<KomoditasDijual, "id">) => {
    ...
    newItem.standardized_stock_periode = calcStandardizedStockPerDay(
      newItem.nilai_stok,
      newItem.nilai_periode,
      newItem.periode_unit,
    );
    persist("komoditasDijual", setKomoditasDijual, (prev) => [
      ...prev,
      newItem,
    ]);
  };

  const createKomoditasDijual = useCallback(
    async (k: Omit<KomoditasDijual, "id">): Promise<KomoditasDijual> => {
      const withStd: Omit<KomoditasDijual, "id"> = {
        ...k,
        standardized_stock_periode: calcStandardizedStockPerDay(
          k.nilai_stok,
          k.nilai_periode,
          k.periode_unit,
        ),
  ...
  const updateKomoditasDijual = useCallback(
    async (
      id: string,
      k: Partial<KomoditasDijual>,
    ): Promise<KomoditasDijual> => {
  ...
  const deleteKomoditasDijual = useCallback(
    async (id: string): Promise<void> => {
  ...
  const addHargaRutin = (h: Omit<HargaRutin, "id">) =>
    persist("hargaRutin", setHargaRutin, (prev) => [
      ...prev,
      { ...h, id: uid() },
    ]);
  const updateHargaRutin = (id: string, h: Partial<HargaRutin>) =>
    persist("hargaRutin", setHargaRutin, (prev) =>
      prev.map((x) => (x.id === id ? { ...x, ...h } : x)),
    );
  const deleteHargaRutin = (id: string) =>
    persist("hargaRutin", setHargaRutin, (prev) =>
      prev.filter((x) => x.id !== id),
    );

  const loadHargaRutinReportGroups = useCallback(async (): Promise<
    HargaRutinReportGroup[]
  > => {
    if (!getAccessToken()) return [];
  ...
  const saveHargaRutinReport = useCallback(
    async (params: {
      activeBatchId: string | null;
      pasarId: string;
      tanggal: Date;
      ...
      const existing = await fetchHargaRutinList({
        id_pengumpulan_data: batchId,
      });
      const desiredKeys = new Set(
        desired.map((r) => `${r.komoditasId}__${r.kelas}`),
      );
      ...
      for (const row of desired) {
        const ex = existing.find(
          (e) =>
            e.id_komoditas === row.komoditasId &&
            e.kelas_komoditas === row.kelas,
        );
        if (ex) {
          if (
            ex.harga !== row.harga ||
            ex.id_tempat_usaha !== row.tempatUsahaId
          ) {
   ...
   */
  const classifyByNormalDist = useCallback(
    (
      items: { tuId: string; avg: number }[],
    ): Record<string, KelasKomoditas> => {
      ...
      const variance =
        items.reduce((s, i) => s + (i.avg - mean) ** 2, 0) / items.length;
   ...
   * Mendapatkan kelas untuk semua TU yang menjual komoditas tertentu di pasar tertentu.
   */
  const getKelasForKomoditasInPasar = useCallback(
    (pasarId: string, komoditasId: string): Record<string, KelasKomoditas> => {
      ...
      if (withKelas.length > 0 && withKelas.length === allKDs.length) {
        const result: Record<string, KelasKomoditas> = {};
        allKDs.forEach((kd) => {
          if (kd.kelas_komoditas)
            result[kd.tempat_usaha_id] = kd.kelas_komoditas;
        });
        return result;
      }
  ...
  /** Mendapatkan kelas untuk setiap komoditas yang dijual oleh suatu TU */
  const getKelasForTU = useCallback(
    (tuId: string): Record<string, KelasKomoditas> => {
      ...
      tuKDs.forEach((kd) => {
        const kelasMap = getKelasForKomoditasInPasar(
          tu.pasar_id,
          kd.komoditas_id,
        );
  ...
  const calculateHargaPelaporan = useCallback((): HargaPelaporan[] => {
    ...
    return Object.entries(grouped).map(([, items]) => {
      ...
      const prices = [besar?.harga, menengah?.harga, kecil?.harga].filter(
